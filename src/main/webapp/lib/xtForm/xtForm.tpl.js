...
(function () {
    ...
    xtForm.provider('xtFormConfig', function () {
        ...
        var self = this,
                _errors = {
                    minlength: 'Precisa ter no mínimo {{ngMinlength}} caracteres de tamanho',
                    maxlength: 'Não pode ter mais que {{ngMaxlength}} caracteres de tamanho',
                    required: 'Este campo é obrigatório',
                    number: 'O valor deve ser um número',
                    min: 'Deve ser no mínimo {{min}}',
                    max: 'Deve ser no máximo{{max}}',
                    email: 'Deve ser um endereço e-mail válido',
                    pattern: 'Valor ilegal',
                    url: 'Deve ser uma URL válida',
                    date: 'Deve ser uma data válida',
                    datetimelocal: 'Deve ser uma data válida',
                    time: 'Deve ser um horário válido',
                    week: 'Deve ser uma semana válida',
                    month: 'Deve ser um mês válido',
                    $$server: 'Aconteceu algo errado'
                },
